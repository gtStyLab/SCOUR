function datasetFileName = wrapper_genOdeData_SmallerModel(paramSetNum,dataDir)
...
% combination of CoV and lo-res nT values. 
    ...
    datasetFileName = sprintf('SmallerModel_k-%02d_hiRes.mat',paramSetNum);
    ...
    try
        paramsVec = getParamsVecNum_SmallerModel(paramSetNum);
    ...
    if ~paramErrorCatch
        ...
        odeDataset.nT = nT;
        odeDataset.paramsVec = paramsVec(1:16);
        odeDataset.x0 = paramsVec(17:22);
...
% %         [odeDataset.timeVec, odeDataset.concMatrix, odeDataset.fluxMatrix] = solveODE(odeDataset.tStart,odeDataset.tEnd,odeDataset.nT,odeDataset.x0,odeDataset.paramsVec);
        [odeDataset.timeVec, odeDataset.concMatrix, odeDataset.fluxMatrix] = solveOdeBstSmallerModel(odeDataset.tStart,odeDataset.tEnd,odeDataset.nT,odeDataset.x0,odeDataset.paramsVec);
