...
if exist('BiggerModel_regScheme_2contMet','var')
    ...
    for regListIndex = 1:length(BiggerModel_regScheme_2contMet)
        ...
        % Functionality feature
        [featureMatrix_2contMet_BiggerModel(1,regListIndex)] = feature_functionality_2contMet(BiggerModel_prefix,met1,met2,tarFlux,num_IC,rep);

        % Surface fit RMSE
        [~, featureMatrix_2contMet_BiggerModel(2,regListIndex)] = feature_surfaceFit_multiContMet(BiggerModel_prefix,met1,met2,tarFlux,num_IC,rep);

        % Predict flux with machine learning
        featureMatrix_2contMet_BiggerModel(3,regListIndex) = feature_predictFlux_multiContMet(BiggerModel_prefix,met1,met2,tarFlux,num_IC,rep);

        % Hold 1 metabolite constant and calculate correlation
        [featureMatrix_2contMet_BiggerModel(4,regListIndex)] = feature_hold1MetConstant_correlation_2contMet(BiggerModel_prefix,met1,met2,tarFlux,num_IC,rep);

        % Hold 1 metabolite constant and fit curve
        [~, featureMatrix_2contMet_BiggerModel(5,regListIndex)] = feature_hold1MetConstant_curveFit_2contMet(BiggerModel_prefix,met1,met2,tarFlux,num_IC,rep);
    end
...
if exist('SmallerModel_regScheme_2contMet','var')
    ...
    for regListIndex = 1:length(SmallerModel_regScheme_2contMet)
        ...
        % Functionality feature
        [featureMatrix_2contMet_SmallerModel(1,regListIndex)] = feature_functionality_2contMet(SmallerModel_prefix,met1,met2,tarFlux,num_IC,rep);

        % Surface fit RMSE
        [~, featureMatrix_2contMet_SmallerModel(2,regListIndex)] = feature_surfaceFit_multiContMet(SmallerModel_prefix,met1,met2,tarFlux,num_IC,rep);

        % Predict flux with machine learning
        featureMatrix_2contMet_SmallerModel(3,regListIndex) = feature_predictFlux_multiContMet(SmallerModel_prefix,met1,met2,tarFlux,num_IC,rep);

        % Hold 1 metabolite constant and calculate correlation
        [featureMatrix_2contMet_SmallerModel(4,regListIndex)] = feature_hold1MetConstant_correlation_2contMet(SmallerModel_prefix,met1,met2,tarFlux,num_IC,rep);

        % Hold 1 metabolite constant and fit curve
        [~, featureMatrix_2contMet_SmallerModel(5,regListIndex)] = feature_hold1MetConstant_curveFit_2contMet(SmallerModel_prefix,met1,met2,tarFlux,num_IC,rep);
    end
