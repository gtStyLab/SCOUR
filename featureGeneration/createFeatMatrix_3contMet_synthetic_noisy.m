...
% BiggerModel feature matrix
    for regListIndex = 1:length(BiggerModel_regScheme_3contMet)
        ...
        % Surface fit RMSE
        [~, featureMatrix_3contMet_BiggerModel(1,regListIndex)] = feature_surfaceFit_multiContMet_noisy(BiggerModel_prefix,remaining_mets,met1,tarFlux,num_IC,nT,cov,rep);

       % Percentage method functionality
        featureMatrix_3contMet_BiggerModel(2,regListIndex) = feature_functionalityPercentage_3contMet_noisy(BiggerModel_prefix,met1,remaining_mets(1),remaining_mets(2),tarFlux,num_IC,nT,cov,rep);

        % Predict flux from metabolites
        featureMatrix_3contMet_BiggerModel(3,regListIndex) = feature_predictFlux_multiContMet_noisy(BiggerModel_prefix,met1,remaining_mets,tarFlux,num_IC,nT,cov,rep);

        % Rounding method functionality
        featureMatrix_3contMet_BiggerModel(4,regListIndex) = feature_functionalityRounding_3contMet_noisy(BiggerModel_prefix,[met1,remaining_mets],tarFlux,num_IC,nT,cov,rep);

        % Hold 2 metabolites constant and calculate correlation
        [featureMatrix_3contMet_BiggerModel(5,regListIndex)] = feature_hold2MetConstant_correlation_3contMet_noisy(BiggerModel_prefix,met1,remaining_mets(1),remaining_mets(2),tarFlux,num_IC,nT,cov,rep);
...
if exist('SmallerModel_regScheme_3contMet','var')
    ...
    for regListIndex = 1:length(SmallerModel_regScheme_3contMet)
        ...
        % Surface fit RMSE
        [~, featureMatrix_3contMet_SmallerModel(1,regListIndex)] = feature_surfaceFit_multiContMet_noisy(SmallerModel_prefix,remaining_mets,met1,tarFlux,num_IC,nT,cov,rep);

       % Percentage method functionality
        featureMatrix_3contMet_SmallerModel(2,regListIndex) = feature_functionalityPercentage_3contMet_noisy(SmallerModel_prefix,met1,remaining_mets(1),remaining_mets(2),tarFlux,num_IC,nT,cov,rep);

        % Predict flux from metabolites
        featureMatrix_3contMet_SmallerModel(3,regListIndex) = feature_predictFlux_multiContMet_noisy(SmallerModel_prefix,met1,remaining_mets,tarFlux,num_IC,nT,cov,rep);

        % Rounding method functionality
        featureMatrix_3contMet_SmallerModel(4,regListIndex) = feature_functionalityRounding_3contMet_noisy(SmallerModel_prefix,[met1,remaining_mets],tarFlux,num_IC,nT,cov,rep);

        % Hold 2 metabolites constant and calculate correlation
        [featureMatrix_3contMet_SmallerModel(5,regListIndex)] = feature_hold2MetConstant_correlation_3contMet_noisy(SmallerModel_prefix,met1,remaining_mets(1),remaining_mets(2),tarFlux,num_IC,nT,cov,rep);
