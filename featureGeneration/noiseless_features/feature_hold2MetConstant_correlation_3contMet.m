function [avg_all] = feature_hold2MetConstant_correlation_3contMet(prefix,met1,met2,met3,tarFlux,num_IC,rep)
...
for IC1 = 1:num_IC
    for IC2 = 1:num_IC
        if IC2 > IC1
            ...
            % Intersection points of met1 vs. met3 for different ICs
            ...
            % Create interpolation models for met2 and flux 
