function SCOUR_Ecoli_noiseless(num_IC,rep)
warning('off','all')
rng('shuffle');
...
createFeatMatrix_1contMet_chass_noiseless
...
testingSet_Chass_1contMet = featureMatrix_1contMet_Chass;
...
if exist('Chass_regScheme_2contMet','var')
    ...
    createFeatMatrix_2contMet_chass_noiseless
    ...
    % Chass
    % Setup testing set and testing label
    testingSet_Chass_2contMet = featureMatrix_2contMet_Chass;
...
if exist('Chass_regScheme_3contMet','var')
    ...
    createFeatMatrix_3contMet_chass_noiseless
    ...
    % Chass
    % Setup testing set and testing label
    testingSet_Chass_3contMet = featureMatrix_3contMet_Chass;
...
save(sprintf('ecoli_results_IC-%02d_rep-%02d.mat',num_IC,rep));
