...
% Find yeast mass action (MA) interactions
...
% List of yeast interactions with one controller metabolite
...
% Remove from yeast model using predicted 1 controller metabolite
% interactions
...
if exist('Hynne_regScheme_2contMet','var')
    ...
    % List of yeast interactions with two controller metabolites
    ...
    % Remove from yeast model using predicted 2 controller metabolite
    % interactions
...
if exist('Hynne_regScheme_3contMet','var')
    ...
    % List of yeast interactions with three controller metabolites
    ...
    % Remove from yeast model using predicted 3 controller metabolite
    % interactions
