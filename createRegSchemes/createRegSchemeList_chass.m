function [regScheme_2contMet,regScheme_3contMet,regScheme_4contMet] = createRegSchemeList_chass(S,fluxes_to_remove)
% Create list of possible regulatory interactions in the E. coli model that
% are tested by SCOUR.
